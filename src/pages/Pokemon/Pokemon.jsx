    ...
    return (
        <div className="pokemon">
            ...
            <form onSubmit={handleSubmit(onSubmitPokemon)}>
                ...
                {errors.nome && <span className="invalid">Digite um tipo válido!</span>}<br />

                <label htmlFor="altura">Altura</label><br />
                <input type="number" id="altura" {...register("altura", { required: true, min: 0, max: 100 })} step="0.01" /><br />
...
// handleSubmit é responsavel por intermediar a captura dos dados do
// formulário e agrupar-las em um objeto "data" e passar para a função
// de tratamento.

//maxLength - numero de caracteres

// min e max - valor digitado
